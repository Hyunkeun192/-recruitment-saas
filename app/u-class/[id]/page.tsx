            ...
            <main className="pt-32 pb-24">
                <article className="max-w-3xl mx-auto px-6">
                    ...
                    <div className="mb-12 text-center">
                        ...
                        <h1 className="text-3xl md:text-5xl font-black text-slate-900 mb-6 leading-tight break-keep">
                            {post.title}
                        </h1>
                    ...
                    {/* Content Body */}
                    <div className="prose prose-lg prose-slate max-w-none prose-headings:font-bold prose-a:text-indigo-600 hover:prose-a:text-indigo-700 prose-img:rounded-2xl prose-img:shadow-md">
                        {/* 
