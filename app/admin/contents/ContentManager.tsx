...
import { AdminContent, createContent, deleteContent, togglePublish } from './actions';
import { Plus, Trash2, Globe, Eye, EyeOff, Film, FileText, ExternalLink } from 'lucide-react';
    ...
    const onSubmit = async (data: ContentFormInputs) => {
        try {
            ...
            if (data.type === 'VIDEO') {
                ...
                // No thumbnail for article in this design
            }
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
                    <div className={`bg-white rounded-2xl w-full ${selectedType === 'ARTICLE' ? 'max-w-4xl' : 'max-w-lg'} max-h-[90vh] overflow-y-auto shadow-2xl transition-all`}>
                        <div className="p-6 border-b border-slate-100 flex justify-between items-center sticky top-0 bg-white z-10">
                            <h2 className="text-xl font-bold text-slate-800">새 콘텐츠 등록</h2>
