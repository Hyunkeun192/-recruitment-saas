            ...
            <div className="bg-white border border-slate-100 rounded-[2.5rem] p-8 shadow-sm">
                ...
                <div className="flex flex-col lg:flex-row gap-10 items-stretch">
                    ...
                    <div className="lg:w-72 bg-slate-50/50 rounded-3xl p-6 border border-slate-100 flex flex-col justify-between overflow-hidden relative">
                        ...
                        {!isFirstAttempt ? (
                            <div className="mt-8 flex items-end justify-between gap-1 h-40 px-1">
                                {attempts.map((a, i) => {
                                    // Adjusted Scale: Min 25, Max 75 for better visibility of T-score variations
                                    const min = 25;
                                    const max = 75;
                                    ...
                                    const content = (
                                        <>
                                            ...
                                            <div className="relative w-full flex justify-center flex-1 items-end">
                                                <div
                                                    className={`w-3 sm:w-4 rounded-t-full transition-all duration-700 ease-out shadow-sm ${a.isCurrent
